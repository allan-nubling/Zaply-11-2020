    ...
    return (
        <div className="about">
            ...
            <div>
                ...
                <br/>Esta é a principal página do desafio. Nela é possível filtrar todos produtos por qualquer atributo, reorganizá-los por qualquer coluna, definir a quantidade disposta na página, editar ou excluir. Aqui eu tentei fazer com que fique o mais fácil possível de encontrar um produto no banco de dados
            </div>
            <div>
            ...
            <div>
                ...
                <br/>Aqui é possível enviar arquivos CSV como os que nos foram passados no desafio.
            </div>
            <br/>
            <h4>O backend:</h4>
            <p>
